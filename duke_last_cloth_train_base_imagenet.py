...
sys.path.append('.')
from data import make_data_loader_last as make_data_loader
from engine.trainer import do_train_strong as do_train
from modeling import build_model
from layers import make_loss
from solver import make_optimizer
from engine.inference import inference, inference_base
import datetime
...
def main(cfg):
    ...
    if cfg.train == 1:
        ...
        last_model_wts = torch.load(os.path.join('pre_feat', 'celeb_last_best.pth'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lastset', type=str, default='last_cloth')
    parser.add_argument('--data_dir', type=str, default='/data/shuxj/data/PReID/dukemtmc-reid/')
    parser.add_argument('--last_dir', type=str, default='/data/shuxj/data/PReID/last_new/last/')

    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/20210206_duke_last_cloth_base_iamgenet/'))
