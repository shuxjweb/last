...
sys.path.append('.')
from data import make_data_loader_data as make_data_loader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data2set', type=str, default='msmt17')

    parser.add_argument('--data_dir', type=str, default='/data/shuxj/data/PReID/dukemtmc-reid/')
    parser.add_argument('--data2_dir', type=str, default='/data/shuxj/data/PReID/msmt17/')

    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/20210206_duke_msmt_base_imagenet/'))
