...
from engine.trainer import do_train_strong as do_train
from modeling import build_model
from layers import make_loss
from solver import make_optimizer
from engine.inference import inference_base
import datetime
...
def main(cfg):
    # prepare dataset
    train_loader, test_loader, num_query, num_classes = make_data_loader(cfg)
    ...
    if cfg.train == 1:
        start_epoch = 0
        acc_best = 0.0
        last_model_wts = torch.load(os.path.join('pre_feat', 'lastcloth_ini_imagenet.pth'))
        ...
        mAP, cmc1, cmc5, cmc10 = inference_base(model, test_loader, num_query)
        ...
        print('{} - Final: mAP: {:.4f}, cmc1: {:.4f}, cmc4: {:.4f}, cmc9: {:.4f}'.format(start_time, mAP, cmc1, cmc5, cmc10))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='dukemtmc')
    parser.add_argument('--data_dir', type=str, default=r'/data/shuxj/data/PReID/dukemtmc-reid/')
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/20210207_duke_base_last_cloth_sgd'))
