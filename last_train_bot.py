...
from engine.trainer import do_train_movie_base as do_train
...
def main(cfg):
    ...
    if cfg.train == 1:
        ...
        # mAP, cmc1, cmc5, cmc10, cmc20, feat_dict = inference(model, test_loader, num_query_test, True)
        #
        # start_time = datetime.datetime.now()
        # start_time = '%4d:%d:%d-%2d:%2d:%2d' % (start_time.year, start_time.month, start_time.day, start_time.hour, start_time.minute, start_time.second)
        # print('{} - Final: cmc1: {:.1%} cmc5: {:.1%} cmc10: {:.1%} cmc20: {:.1%} mAP: {:.1%}\n'.format(start_time, cmc1, cmc5, cmc10, cmc20, mAP))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--optimizer_name', type=str, default="Adam", help="Adam, SGD")
    ...
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/20210407_last_bot_base'))
