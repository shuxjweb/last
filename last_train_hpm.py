...
from engine.trainer import do_train_movie_hpm as do_train
from modeling import build_model
from layers import make_loss_with_triplet_entropy
from solver import make_optimizer, WarmupMultiStepLR
from engine.inference import inference_movie as inference
import datetime
...
def main(cfg):
    ...
    # prepare model
    model = build_model(num_classes, 'hpm')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/20201110_movie_hpm/'))
