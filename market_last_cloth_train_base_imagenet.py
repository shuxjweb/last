...
sys.path.append('.')
from data import make_data_loader_path_last as make_data_loader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/20210206_market_last_cloth_base_imagenet'))
