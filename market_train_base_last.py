...
def main(cfg):
    ...
    if cfg.train == 1:
        start_epoch = 0
        acc_best = 0.0
        last_model_wts = torch.load(os.path.join('pre_feat', 'last_cloth_best.pth'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/20210207_market_base_last_cloth_sgd'))
