...
def main(cfg):
    ...
    if cfg.train == 1:
        ...
        mAP, cmc1, cmc5, cmc10, cmc20 = inference(model, test_loader, num_query, False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/data/shuxj/data/PReID/msmt17/')
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/20210203_msmt_base_imagenet_35e3'))
