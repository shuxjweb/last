...
from engine.trainer import do_train_prcc_global_adversarial_base as do_train
...
def main(cfg):
    # prepare dataset
    train_loader, train_loader_ca, train_loader_cb, val_loader_c, val_loader_b, num_query_c, num_query_b, num_classes = make_data_loader(cfg, use_eraser=True)  # num_query=3368, num_classes=751
