...
from layers import make_loss_with_center, make_loss_with_triplet_entropy, make_loss
from solver import make_optimizer, make_optimizer_with_center, WarmupMultiStepLR
from engine.inference import inference, inference_base, inference_prcc_global
import datetime
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/20210205_prcc_base_msmt_sgd2'))
